...
namespace pibotuwp.Pages
{
    /// <summary>
    /// An empty page that can be used on its own or navigated to within a Frame.
    /// </summary>
    public sealed partial class MaestroSerialPage : Page
    {
        /// <summary>
        /// Private variables
        /// </summary>
        ...
        private async Task WriteBytesAsync(byte[] command)
        {
            Task<UInt32> storeAsyncTask;
        ...
        private async void btnGetPosition_Click(object sender, RoutedEventArgs e)
        {
