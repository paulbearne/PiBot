namespace UWPBiped
{
    ...
    /// </remarks>
    struct JavaScriptProjectionCallbackContext
    {
        /// <summary>
        /// The reference.
        /// </summary>
    ...
    delegate void JavaScriptProjectionCallback(JavaScriptProjectionCallbackContext jsContext);
    ...
    delegate void JavaScriptProjectionEnqueueCallback(JavaScriptProjectionCallback jsCallback, JavaScriptProjectionCallbackContext jsContext, IntPtr callbackState);
}
